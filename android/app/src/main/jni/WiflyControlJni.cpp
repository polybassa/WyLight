...
jlong Java_de_WyLight_WyLight_BroadcastReceiver_getNextRemote(JNIEnv* env,
                                                              jobject ref,
                                                              jlong   pNative,
                                                              jlong   timeoutNanos)
{
...
jlong Java_de_WyLight_WyLight_library_Endpoint_connect(JNIEnv* env,
                                                       jobject ref,
                                                       jlong   pBroadcastReceiver,
                                                       jlong   fingerprint)
{
    try {
...
jstring Java_de_WyLight_WyLight_library_Endpoint_getEndpointName(JNIEnv* env,
                                                                 jobject ref,
                                                                 jlong   pBroadcastReceiver,
                                                                 jlong   fingerprint)
{
...
void Java_de_WyLight_WyLight_library_Endpoint_setEndpointName(JNIEnv* env,
                                                              jobject ref,
                                                              jlong   pBroadcastReceiver,
                                                              jlong   fingerprint,
                                                              jstring deviceId)
...
jboolean Java_de_WyLight_WyLight_WiflyControl_ConfSetWlan(JNIEnv*  env,
                                                          jobject  ref,
                                                          jlong    pNative,
                                                          jstring  passphrase,
                                                          jstring  ssid,
...
jboolean Java_de_WyLight_WyLight_WiflyControl_FwSetFade(JNIEnv* env,
                                                        jobject ref,
                                                        jlong   pNative,
                                                        jint    argb,
                                                        jint    addr,
...
{
    return TrySend(env,
                   reinterpret_cast<Control*>(pNative),
                   FwCmdSetFade {(uint32_t)argb, (uint16_t)fadeTime, (uint32_t)addr, false}
                   );
}

jboolean Java_de_WyLight_WyLight_WiflyControl_FwSetGradient(JNIEnv* env,
                                                            jobject ref,
                                                            jlong   pNative,
                                                            jint    argb_1,
                                                            jint    argb_2,
                                                            ...
                                                            jshort  fadeTime)
{
    return TrySend(env, reinterpret_cast<Control*>(pNative),
                   FwCmdSetGradient(argb_1, argb_2, fadeTime, false, length, offset));
}
...
void Java_de_WyLight_WyLight_library_FwCmdScriptAdapter_setFadeTime(JNIEnv* env, jobject ref, jlong pNative,
                                                                    jshort tmms)
{
    auto fadeCommand = reinterpret_cast<FwCmdSetFade*>(pNative);
...
void Java_de_WyLight_WyLight_library_FwCmdScriptAdapter_setGradientColors(JNIEnv* env,
                                                                          jobject ref,
                                                                          jlong   pNative,
                                                                          jint    startArgb,
                                                                          jint    endArgb)
...
void Java_de_WyLight_WyLight_library_ScriptAdapter_addFade(JNIEnv* env,
                                                           jobject ref,
                                                           jlong   pNative,
                                                           jint    argb,
                                                           jint    addr,
...
void Java_de_WyLight_WyLight_library_ScriptAdapter_addGradient(JNIEnv* env,
                                                               jobject ref,
                                                               jlong   pNative,
                                                               jint    argb_1,
                                                               jint    argb_2,
                                                               jshort  fadeTime)
{
    reinterpret_cast<Script*>(pNative)->push_back(std::unique_ptr<FwCmdScript>(new FwCmdSetGradient(argb_1, argb_2,
                                                                                                    fadeTime)));
}
...
jstring Java_de_WyLight_WyLight_library_ScriptManagerAdapter_getScriptName(JNIEnv* env,
                                                                           jobject ref,
                                                                           jstring path,
                                                                           jint    index)
{
...
void Java_de_WyLight_WyLight_library_ScriptManagerAdapter_newScript(JNIEnv* env,
                                                                    jobject ref,
                                                                    jstring path,
                                                                    jstring scriptName)
{
...
void Java_de_WyLight_WyLight_library_ScriptManagerAdapter_saveScript(JNIEnv* env,
                                                                     jobject ref,
                                                                     jstring path,
                                                                     jlong   pNativeScript)
{
