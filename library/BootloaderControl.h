...
/* ------------------------- BOOTLOADER METHODES ------------------------- */
     ...
     * @throw InvalidParameter a parameter is out of bound
     */
    void BlReadCrcFlash(std::ostream& out, uint32_t address, size_t numBytes) const throw (ConnectionTimeout,
                                                                                           FatalError,
                                                                                           InvalidParameter);
     ...
     * @throw InvalidParameter a parameter is out of bound
     */
    void BlReadEeprom(std::ostream& out, uint32_t address, size_t numBytes) const throw (ConnectionTimeout, FatalError,
                                                                                         InvalidParameter);
     ...
     * @throw InvalidParameter a parameter is out of bound
     */
    void BlReadFlash(std::ostream& out, uint32_t address, size_t numBytes) const throw (ConnectionTimeout, FatalError,
                                                                                        InvalidParameter);
...
private:
     ...
     * @throw FatalError if command code of the response doesn't match the code of the request, or too many retries failed
     */
    void BlEraseFlashArea(const uint32_t endAddress, const uint8_t numPages) const throw (ConnectionTimeout,
                                                                                          FatalError);
     ...
     * @throw InvalidParameter a parameter is out of bound
     */
    void BlWriteEeprom(uint32_t address, const uint8_t* pBuffer, size_t bufferLength) const throw (ConnectionTimeout,
                                                                                                   FatalError,
                                                                                                   InvalidParameter);
     ...
     * @throw InvalidParameter a parameter is out of bound
     */
    void BlWriteFlash(uint32_t address, uint8_t* pBuffer, size_t bufferLength) const throw (ConnectionTimeout,
                                                                                            FatalError,
                                                                                            InvalidParameter);
     ...
     * @throw InvalidParameter a parameter is out of bound
     */
    size_t BlReadCrcFlash(uint8_t* pBuffer, uint32_t address, uint16_t numBytes) const throw (ConnectionTimeout,
                                                                                              FatalError,
                                                                                              InvalidParameter);
     ...
     * @throw InvalidParameter a parameter is out of bound
     */
    size_t BlReadEeprom(uint8_t* pBuffer, uint32_t address, size_t numBytes) const throw (ConnectionTimeout, FatalError,
                                                                                          InvalidParameter);
     ...
     * @throw InvalidParameter a parameter is out of bound
     */
    size_t BlReadFlash(uint8_t* pBuffer, uint32_t address, size_t numBytes) const throw (ConnectionTimeout, FatalError,
                                                                                         InvalidParameter);
