...
X86_CLIENT_BUILD=g++ WiflyControlColorClass.cpp BroadcastReceiver.cpp ClientSocket.cpp ComProxy.cpp crc.c intelhexclass.cpp TelnetResponse.cpp WiflyControl.cpp WiflyControlCli.cpp -DX86 -lpthread -o client.bin -Wall -pedantic -std=c++0x
