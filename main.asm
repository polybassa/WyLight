...
; 0x09C6 P1   18 word(s)  0 % : ledstrip_init
; 0x09D8 P1   66 word(s)  3 % : ledstrip_set_color
; 0x0A1A P1   61 word(s)  2 % : sub_func_set_color
