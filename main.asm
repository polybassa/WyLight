...
EEPROM_RD
	...
	RETURN
			...
			;
			;void EEPROM_WR_BLK(char *array, char adress, char length)			//Zum Ausf¸hren eines beliebigen Befehls durch den Programmcode
			;{
EEPROM_WR_BLK
	MOVLB 0
	MOVWF length_2
...
m011	RETURN
			...
			;
			;void EEPROM_RD_BLK(char *array, char adress, char length)			//Zum Ausf¸hren eines beliebigen Befehls durch den Programmcode
			;{
EEPROM_RD_BLK
	MOVWF length_3
			;	if(!array) return;
...
; 0x0019 P0   54 word(s)  2 % : init_all
; 0x004F P0   28 word(s)  1 % : throw_errors
; 0x006B P0  165 word(s)  8 % : get_commands
; 0x0110 P0   37 word(s)  1 % : execute_commands
; 0x0135 P0   68 word(s)  3 % : sub_func_set_color
...
; 0x0976 P1    8 word(s)  0 % : spi_init
; 0x097E P1    9 word(s)  0 % : spi_send
; 0x0987 P1   10 word(s)  0 % : spi_receive
; 0x0991 P1   26 word(s)  1 % : spi_send_arr
