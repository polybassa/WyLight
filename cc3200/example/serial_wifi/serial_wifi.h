...
extern union
{
	...
	UINT32 demobuf[MCU_RX_BUFFER_OVERHEAD_SIZE/4];
} uBufuRx;
...
extern char 				*g_pcSsid, *g_pcIp, *g_pcPort, *g_pcProtocol, *g_pcData, *g_pcLength, *g_pcTimeout, *g_pcPingAttempts,*g_mDNSMode, *g_UserName,*g_Key;
...
int btoa();
int htoa();
int ExecuteCommand(OperationMode_e local);
